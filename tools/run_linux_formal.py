...
TRACK_VARIANT_TO_CONFIG = {
    ...
    ("non_dann", "svd"): "configs/linux_non_dann_svd_accuracy.yaml",
    ("non_dann", "mixed_svd"): "configs/linux_non_dann_mixed_svd_accuracy.yaml",
    ...
    ("non_dann", "short_aug"): "configs/linux_non_dann_short_aug_accuracy.yaml",
    ("non_dann", "short_aug_mid"): "configs/linux_non_dann_short_aug_mid_accuracy.yaml",
    ("non_dann", "short_aug_strong"): "configs/linux_non_dann_short_aug_strong_accuracy.yaml",
    ("non_dann", "short_reg_aug_repro"): "configs/linux_non_dann_short_reg_aug_repro_accuracy.yaml",
